...
- (void)testCreate
{
	...
	XCTAssertEqual(1, (int)version.major, @"version.major is not the correct value %d", version.major);
	XCTAssertEqual(2, (int)version.minor, @"version.minor is not the correct value %d", version.minor);
	XCTAssertEqual(3, (int)version.maintenance, @"version.maintenance is not the correct value %d", version.maintenance);

	version = [DTVersion versionWithString:@"2.9999"];
	XCTAssertNotNil(version, @"DTVersion object should be create");
	XCTAssertEqual(2, (int)version.major, @"version.major is not the correct value %d", version.major);
	XCTAssertEqual(9999, (int)version.minor, @"version.minor is not the correct value %d", version.minor);
	XCTAssertEqual(0, (int)version.maintenance, @"version.maintenance is not the correct value %d", version.maintenance);

	version = [DTVersion versionWithString:@"1"];
	XCTAssertNotNil(version, @"DTVersion object should be create");
	XCTAssertEqual(1, (int)version.major, @"version.major is not the correct value %d", version.major);
	XCTAssertEqual(0, (int)version.minor, @"version.minor is not the correct value %d", version.minor);
	XCTAssertEqual(0, (int)version.maintenance, @"version.maintenance is not the correct value %d", version.maintenance);
	...
	XCTAssertEqual(2, (int)version.minor, @"version.minor is not the correct value %d", version.minor);
	XCTAssertEqual(3, (int)version.maintenance, @"version.maintenance is not the correct value %d", version.maintenance);
	XCTAssertEqual(4, (int)version.build, @"version.build is not the correct value %d", version.build);
}
